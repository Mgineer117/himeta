...
def get_args():
    ...
    parser.add_argument('--max-num-trj', type=int, default=400)
...
def train(args=get_args()):
    ...
    for seed in args.seeds:
        ...
        if args.import_policy:
            ...
            actor, critic, int_level_model, high_level_model = pickle.load(open('model/model.p', "rb"))
            low_level_model.actor = actor
            low_level_model.critic = critic
